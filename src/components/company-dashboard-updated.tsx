                  ...
                  <div className="flex space-x-2">
                    ...
                    <Dialog>
                      ...
                      <DialogContent>
                        ...
                        {/* Maintenance Request Form - same as above */}
                      </DialogContent>
                    </Dialog>
                  </div>
                </div>
              ...
              <CardContent>
                    ...
                    {maintenanceRequests.map((request) => {
                      ...
                      return (
                        <TableRow key={request.id}>
                          ...
                          <TableCell>{getStatusBadge(request.status, 'maintenance')}</TableCell>
                ...
                {maintenanceRequests.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400">All properties are in good condition</p>
                  </div>
                )}
              </CardContent>
            </Card>
